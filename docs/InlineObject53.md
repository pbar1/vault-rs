...
------------ | ------------- | ------------- | -------------
**base_url** | Option<**String**> | The API endpoint to use. Useful if you are running GitHub Enterprise or an API-compatible authentication server. | [optional]
...
**organization** | Option<**String**> | The organization users must be part of | [optional]
...
**token_policies** | Option<**Vec<String>**> | Comma-separated list of policies. This will apply to all tokens generated by this auth method, in addition to any policies configured for specific users/groups. | [optional]
