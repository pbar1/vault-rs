...
------------ | ------------- | ------------- | -------------
**audience** | Option<**String**> | Optional Audience claim to verify in the jwt. | [optional]
...
**bound_service_account_names** | Option<**Vec<String>**> | List of service account names able to access this role. If set to \"*\" all names are allowed. | [optional]
**bound_service_account_namespaces** | Option<**Vec<String>**> | List of namespaces allowed to access this role. If set to \"*\" all namespaces are allowed. | [optional]
