...
------------ | ------------- | ------------- | -------------
**config** | Option<[**serde_json::Value**](.md)> | Configuration for this mount, such as plugin_name. | [optional]
...
**plugin_name** | Option<**String**> | Name of the auth plugin to use based from the name in the plugin catalog. | [optional]
**seal_wrap** | Option<**bool**> | Whether to turn on seal wrapping for the mount. | [optional][default to false]
**_type** | Option<**String**> | The type of the backend. Example: \"userpass\" | [optional]
