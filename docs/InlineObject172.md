...
**csr** | Option<**String**> | PEM-format CSR to be signed. Values will be taken verbatim from the CSR, except for basic constraints. | [optional][default to ]
...
**role** | Option<**String**> | The desired role with configuration for this request | [optional]
