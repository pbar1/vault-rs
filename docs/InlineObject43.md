...
------------ | ------------- | ------------- | -------------
**bound_group_ids** | Option<**Vec<String>**> | Comma-separated list of group ids that login is restricted to. | [optional]
**bound_locations** | Option<**Vec<String>**> | Comma-separated list of locations that login is restricted to. | [optional]
**bound_resource_groups** | Option<**Vec<String>**> | Comma-separated list of resource groups that login is restricted to. | [optional]
**bound_scale_sets** | Option<**Vec<String>**> | Comma-separated list of scale sets that login is restricted to. | [optional]
**bound_service_principal_ids** | Option<**Vec<String>**> | Comma-separated list of service principal ids that login is restricted to. | [optional]
**bound_subscription_ids** | Option<**Vec<String>**> | Comma-separated list of subscription ids that login is restricted to. | [optional]
