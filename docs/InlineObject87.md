...
------------ | ------------- | ------------- | -------------
**dial_timeout** | Option<**i32**> | Number of seconds before connect times out (default: 10) | [optional][default to 10]
**host** | Option<**String**> | RADIUS server host | [optional]
**nas_identifier** | Option<**String**> | RADIUS NAS Identifier field (optional) | [optional][default to ]
**nas_port** | Option<**i32**> | RADIUS NAS port field (default: 10) | [optional][default to 10]
**port** | Option<**i32**> | RADIUS server port (default: 1812) | [optional][default to 1812]
**read_timeout** | Option<**i32**> | Number of seconds before response times out (default: 10) | [optional][default to 10]
**secret** | Option<**String**> | Secret shared with the RADIUS server | [optional]
...
**token_policies** | Option<**Vec<String>**> | Comma-separated list of policies. This will apply to all tokens generated by this auth method, in addition to any configured for specific users. | [optional]
...
**unregistered_user_policies** | Option<**String**> | Comma-separated list of policies to grant upon successful RADIUS authentication of an unregisted user (default: empty) | [optional][default to ]
